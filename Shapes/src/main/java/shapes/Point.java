...
public class Point {
    ...
    public Point(double x, double y) throws ShapeException {
        ValidateDouble.checkDouble(x, "Invalid x-location");
        ValidateDouble.checkDouble(y, "Invalid y-location");
        this.x = x;
        this.y = y;
    }
    ...
    public void moveX(double deltaX) throws ShapeException {
        ValidateDouble.checkDouble(deltaX, "Invalid delta-x value");
        x += deltaX;
    }
    ...
    public void moveY(double deltaY) throws ShapeException {
        ValidateDouble.checkDouble(deltaY, "Invalid delta-y value");
        y += deltaY;
    }
